...
for url in urls:
    ...
    res = 1
    while res < 10000:
        buttons = driver.find_elements_by_xpath("//button[@class='gs_btnPR gs_in_ib gs_btn_half gs_btn_lsb gs_btn_srt gsc_pgn_pnx']")
        if len(buttons) > 0:
            ...
            try:
                wait.until(EC.visibility_of_element_located((By.ID, 'gsc_sa_ccl')))  # espera que cargue data parent element
